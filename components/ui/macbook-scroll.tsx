...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] flex flex-col items-center py-0 md:pb-80 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
...
export const Lid = ({
  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        style={{
          transform: "perspective(800px) rotateX(-19deg) translateZ(0px)",
          transformOrigin: "bottom",
          transformStyle: "preserve-3d",
        }}
        className="h-[11rem] w-[34rem] bg-[#202030] rounded-2xl p-2 relative "
      >
        <div
          style={{
            boxShadow: "0px 2px 0px 2px var(--neutral-900) inset",
          }}
          className="absolute inset-0 bg-[#101010] rounded-lg flex items-center justify-center"
        >
        </div>
      </div>
      <motion.div
        ...
        className="ml-4 h-[15.375rem] w-[32rem] flex items-center justify-center absolute inset-0 bg-[#010101] rounded-2xl"
      >
        <Image
          src={src as string}
          alt="aceternity logo"
          fill
          className="object-fit rounded-lg inset-0 h-full w-full drop-shadow-2xl shadow-black dark:shadow-white"
        />
      </motion.div>
    </div>
  );
